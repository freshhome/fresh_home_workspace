...
abstract class UserRepositories {
  Future<Either<Failure, UserProfile>> signUp(String email, String password, String firstName, String lastName, {String? redirectTo});
  ...
  Future<Either<Failure, void>> verifyRecoveryOtp({required String email, required String token});
