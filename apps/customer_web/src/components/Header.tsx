      ...
      >
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-1 lg:gap-2 bg-white/5 border border-white/10 px-4 py-1.5 rounded-full backdrop-blur-md">
              ...
              <button
                ...
                className={`px-4 py-1.5 text-xs font-bold rounded-full transition-all cursor-pointer ${
                  activeTab === "orders" || pathname === "/orders"
                    ? "bg-[#0091FF] text-white shadow-md shadow-blue-500/30"
                    : "text-slate-200 hover:text-white hover:bg-white/10"
                }`}
              >
            ...
            <div className="hidden sm:flex items-center gap-3">
              ...
              {user ? (
                ...
                <Link
                  href="/profile"
                  className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl border border-blue-500/30 bg-blue-500/10 hover:bg-blue-500/20 text-white transition-all group cursor-pointer shadow-sm"
                ...
                >
                  <div className="relative flex items-center justify-center">
                    ...
                    <span className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-emerald-500 ring-2 ring-[#071330]"></span>
                  </div>
                  <div className="text-right flex flex-col justify-center">
                    <span className="text-xs font-black leading-tight text-white group-hover:text-[#22A5FC] transition-colors max-w-[120px] truncate">
                      {displayName}
                    </span>
                ...
                <Link
                  href="/login"
                  className="flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 text-white transition-all group cursor-pointer"
                  title="تسجيل الدخول إلى حسابك"
                >
                  <LogIn className="w-4 h-4 text-[#22A5FC] group-hover:scale-110 transition-transform" />
            ...
            <div className="flex sm:hidden items-center gap-2">
              ...
              {user ? (
                ...
                >
                  ...
                  <span className="absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-emerald-500 ring-1 ring-[#071330]"></span>
                </Link>
              ) : (
                <Link
                  href="/login"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/10 bg-white/10 text-white text-xs font-bold"
                >
                  <LogIn className="w-3.5 h-3.5 text-[#22A5FC]" />
                  <span>دخول</span>
                </Link>
              )}
              ...
              <button
                ...
                className="p-2 rounded-lg text-slate-300 hover:text-white bg-white/10 cursor-pointer"
              >
                {isDark ? (
        ...
        {isOpen && (
          <div className="sm:hidden bg-[#06112c] border-b border-slate-800 px-4 pt-3 pb-6 space-y-2 mt-3 animate-fade-in-up">
            ...
            <div className="pb-2 mb-2 border-b border-white/10">
              {user ? (
                <Link
                  ...
                  className="flex items-center justify-between p-3 rounded-xl border border-[#0091FF]/30 bg-[#0091FF]/10 text-white transition-all"
                >
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      <span className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-emerald-500 ring-2 ring-[#06112c]"></span>
                    </div>
                ...
                <Link
                  href="/login"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center justify-between p-3 rounded-xl border border-white/10 bg-white/5 text-slate-200 hover:bg-white/10 transition-all"
                >
                  <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => handleNavClick("services", "services")}
              className="w-full text-right block px-3 py-2 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5"
            >
              الخدمات
            </button>
            ...
            <div className="pt-3 border-t border-white/10 flex items-center justify-between">
              <button
                onClick={toggleTheme}
                className="w-full flex items-center justify-center gap-2 text-xs font-bold text-slate-300 bg-white/10 py-2.5 rounded-xl"
              >
                {isDark ? (
                  <>
                    <Sun className="w-4 h-4 text-amber-400" />
