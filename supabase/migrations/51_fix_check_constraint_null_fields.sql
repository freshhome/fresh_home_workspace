-- Migration ID: 51_fix_check_constraint_null_fields
-- Description: Redefine validate_price_config function to correctly handle null values 
-- for base_price_formula and JSONB null checks on fields/options.
...
-- 2. Redefine the validation function
