-- Migration ID: 66_fix_trigger_ledger_fallback_technician_payout
-- Description: Fix ledger entries check constraint error by adding a fallback commission/payout calculation if metadata is missing or zero.
