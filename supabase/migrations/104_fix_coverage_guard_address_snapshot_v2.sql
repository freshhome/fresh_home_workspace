-- ==============================================================================
-- Migration: 104_fix_coverage_guard_address_snapshot_v2.sql
-- Description: Fix coverage guard in create_atomic_booking to support Address Snapshot V2
--              (nested address object, bilingual fields, and reference IDs)
-- ==============================================================================
...
BEGIN
    ...
    -- Supports:
    -- 1) V2 nested address snapshot: p_address_snapshot -> 'address' ->> 'governorate_ar' / 'governorate'
    -- 2) Legacy / flat root-level snapshot: p_address_snapshot ->> 'governorate_ar' / 'governorate'
    -- 3) Reference IDs: governorate_id = 1 (Cairo) or 2 (Giza)
    -- 4) Bilingual English / Latin names: 'Cairo', 'Giza', etc.
