-- Migration ID: 54_clamp_base_price_to_minimum
-- Description: Update stage_5_finalize_pricing to clamp the base price of the service to its minimum price config,
-- ensuring that the base price shown is at least the min_price, rather than clamping the total price silently.
-- This aligns user expectations and matches basePrice + extraFees - discount = total equation.
